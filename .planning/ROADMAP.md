...
- [x] 22-07-PLAN.md — Live data import (manual handle verification gate + run importer + --migrate-legacy)
- [x] 22-08-PLAN.md — E2E playwright smoke across 13 routes × 2 locales
